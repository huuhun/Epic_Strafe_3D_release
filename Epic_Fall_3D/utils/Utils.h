...
void restart(std::vector<glm::vec3>& cubePos, std::vector<glm::vec3>& spinCubePos, std::vector<glm::vec3>& spinCubeAxes, std::vector<glm::vec3>& leftBoundaryPos, std::vector<glm::vec3>& rightBoundaryPos, std::vector<glm::vec3>& topBoundaryPos, std::vector<glm::vec3>& bottomBoundaryPos, float& moventSpeed);
